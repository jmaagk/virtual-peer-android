...
class MeditationChatExercise(context: Context, meditationExercise: MeditationExercise, chatFragment: ChatFragment) :
    ChatExercise(context, meditationExercise, chatFragment) {
